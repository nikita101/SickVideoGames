                    ...
                    <div class="game mt-8">
                        <div class="relative inline-block">
                            @if (array_key_exists('cover', $similarGame)) 
                                <a href='#'>
                                    <img src="{{ Str::replaceFirst('thumb', 'screenshot_huge', $similarGame['cover']['url']) }}" alt="game cover" class="hover:opacity-75 transition ease-in-out duration-150">
                                </a>
                        ...
                        <a href="#" class="block text-base font-semibold leading-tight hover:text-gray-400 mt-8">{{ $similarGame['name'] }}</a>
